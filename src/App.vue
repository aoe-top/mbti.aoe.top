    ...
    <div class="app-wrapper">
        <nav class="nav">
            <div class="container nav-content">
                <router-link :to="getLocalizedRoute('home')" class="nav-brand"
                    >MBTI测试</router-link
                >
                ...
                <div
                    ...
                    >
                    <router-link
                        :to="getLocalizedRoute('test')"
                        class="nav-link"
                        @click="closeMobileMenu"
                        >{{ $t("nav.test") }}</router-link
                    >
                    <router-link
                        :to="getLocalizedRoute('about')"
                        class="nav-link"
                        @click="closeMobileMenu"
                    ...
                    <a
                        href="https://github.com/3DMXM/mbti.aoe.top"
                        target="_blank"
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="friendly-links-panel">
                    ...
                    <div
                        v-if="friendlyLinksPending"
                        class="friendly-links-state">
                        友链加载中...
                    </div>
                    <div
                        v-else-if="friendlyLinksFailed"
                        class="friendly-links-state">
                        友链加载失败，请稍后重试。
                    </div>
...
const handleClickOutside = (event: Event) => {
    if (
        ...
        !languageSwitcher.value.contains(event.target as Node)
    ) {
        closeLanguageMenu();
    }
};
